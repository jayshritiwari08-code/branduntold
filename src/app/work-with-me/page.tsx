  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="font-sans tracking-[4px] text-gold text-xs mb-3 uppercase"
        ...
        <h2
          className="font-serif text-3xl text-white mb-4 leading-snug"
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, #d4af37 0%, #f0d060 50%, #8f6d1d 100%)',
          }}
        >
          Close
        </button>
    ...
    >
      ...
      <div className="relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="text-center" data-aos="fade-up">
              <p className="font-sans tracking-[3px] text-gold text-sm mb-4">
                {contactUsHeadingLoading ? 'Loading...' : contactUsHeading?.tagline || "LET'S CREATE SOMETHING MEANINGFUL"}
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <section
            className="mb-20 prose prose-lg prose-invert text-center max-w-none"
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <section className="mb-20" data-aos="fade-up" data-aos-delay="200">
            <h2 className="font-serif text-3xl text-gold mb-10 text-center">
              {servicesDataLoading ? 'Loading...' : servicesData?.heading || 'Services'}
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {servicesDataLoading ? (
                ...
                servicesData.card_heading.map((title: string, index: number) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-grey leading-relaxed">
                      {servicesData.cards_description && servicesData.cards_description[index]
                        ? servicesData.cards_description[index]
                        : 'Service description'}
                    </p>
                  </div>
                ))
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-grey">
                ...
                <a
                  href={`mailto:${footerData?.email || 'hello@branduntold.com'}`}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-8 w-1/2 py-3 bg-gradient-to-r from-gold via-yellow-200 to-[#8f6d1d] text-black font-bold transition-all duration-300 text-center rounded-lg relative overflow-hidden
                    hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]
            ...
            >
              <div className="p-8 md:p-10 border-b border-gold/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <a
                  href={
                    footerData.map ||
                    `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(footerData.address || '')}`
                  }
                  target="_blank"
